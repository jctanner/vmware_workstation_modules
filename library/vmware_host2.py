...
class VMwareHost(object):
    ...
    def process_state(self):
        try:
            ...
            import q; q('pre host_states')
            host_states[self.state][self.check_host_state()]()
            import q; q('post host_states')

        except vmodl.RuntimeFault as runtime_fault:
            import q; q(runtime_fault)
            self.module.fail_json(msg=runtime_fault.msg)
        except vmodl.MethodFault as method_fault:
            import q; q(method_fault)
...
def main():
    ...
    argument_spec.update(dict(datacenter_name=dict(required=False, type='str'),
    ...
    import q; q('init vmwarehost')
    vmware_host = VMwareHost(module)
    import q; q('process state')
